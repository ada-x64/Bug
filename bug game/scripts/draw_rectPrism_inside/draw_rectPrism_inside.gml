...
var drawSouth	= true;
var drawEast	= true;
var texpos_h	= (xx+L)/sprite_get_width(spr);
var texpos_v	= (yy+H)/sprite_get_height(spr);
...
if drawNorth
{
	...
	vertex_position_3d(vb,xx+L,yy,zz);		//bottom right
		vertex_normal(vb,-1,-1,-1);
		vertex_color(vb,c_white,1);
		vertex_texcoord(vb,texpos_h,texpos_v);
	vertex_position_3d(vb,xx,yy,zz);			//bottom left
		vertex_normal(vb,1,-1,-1);
		vertex_color(vb,c_white,1);
		vertex_texcoord(vb,0,texpos_v);
